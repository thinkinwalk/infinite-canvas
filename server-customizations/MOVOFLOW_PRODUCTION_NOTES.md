...
- Current production image: ghcr.io/thinkinwalk/infinite-canvas:v0.18.6
...
```bash
/opt/infinite-canvas/deploy_infinite_canvas_image.sh ghcr.io/thinkinwalk/infinite-canvas:v0.18.6
```
...
2. Confirm the image tag exists, for example ghcr.io/thinkinwalk/infinite-canvas:v0.18.6.
3. SSH to production:
...
- Release tag deployed for the video model visibility fix: v0.18.6
- Relevant image: ghcr.io/thinkinwalk/infinite-canvas:v0.18.6
...
- Production container image: ghcr.io/thinkinwalk/infinite-canvas:v0.18.6.
- Production container /app/VERSION: v0.18.6.
