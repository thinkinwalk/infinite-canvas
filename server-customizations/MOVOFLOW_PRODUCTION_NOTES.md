...
- Current production image: ghcr.io/thinkinwalk/infinite-canvas:v0.19.1
...
```bash
/opt/infinite-canvas/deploy_infinite_canvas_image.sh ghcr.io/thinkinwalk/infinite-canvas:v0.19.1
```
...
2. Confirm the image tag exists, for example ghcr.io/thinkinwalk/infinite-canvas:v0.19.1.
3. SSH to production:
...
- Release tag deployed for the current production fixes: v0.19.1
- Relevant image: ghcr.io/thinkinwalk/infinite-canvas:v0.19.1
...
- Production container image: ghcr.io/thinkinwalk/infinite-canvas:v0.19.1.
- Production container /app/VERSION: v0.19.1.
