...
- Current production image: ghcr.io/thinkinwalk/infinite-canvas:v0.18.7
...
```bash
/opt/infinite-canvas/deploy_infinite_canvas_image.sh ghcr.io/thinkinwalk/infinite-canvas:v0.18.7
```
...
2. Confirm the image tag exists, for example ghcr.io/thinkinwalk/infinite-canvas:v0.18.7.
3. SSH to production:
...
- Release tag deployed for the video model visibility fix: v0.18.7
- Relevant image: ghcr.io/thinkinwalk/infinite-canvas:v0.18.7
...
- Production container image: ghcr.io/thinkinwalk/infinite-canvas:v0.18.7.
- Production container /app/VERSION: v0.18.7.
